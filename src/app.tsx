...
export default function App() {
    ...
    const [summerData, setSummerData] = useState<
        [{ azimuth: number; altitude: number }] | undefined
    >(undefined);
    ...
    return (
        <div style={{display: "block", fontSize: "12px"}}>
            <div style={{marginBottom: "12px"}}>Inspect if there are hills or mountains outside your map area that block the light. Preview or add horizon geometry to your proposal to get more accurate sun results.</div>
            {horizonData && summerData && winterData &&<HorizonGraph horizon={horizonData} summer={summerData} winter={winterData} />}
